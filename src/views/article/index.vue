    ...
    <div class="main-wrap">
      ...
      <div class="article-detail" v-else-if="article.title">
        ...
        <van-cell class="user-info" center :border="false">
          ...
          <div slot="label" class="publish-date">{{article.pubdate | formateDate}}</div>
          <!-- 关注 -->
          <follow-user v-model="article.is_followed" :article-id="article.aut_id"></follow-user>
        </van-cell>
        <!-- /用户信息 -->
      ...
      <!-- 加载失败：404 -->
      <div class="error-wrap" v-else-if="!isLoading && errStatus === 404">
...
export default {
  ...
  methods: {
    ...
    // 图片预览
    previewImg () {
      const img = this.$refs['article-content']
